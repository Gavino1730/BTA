...
def build_seed_rows(team_payload: dict[str, Any], config: SeedConfig, source_name: str) -> dict[str, list[dict[str, Any]]]:
    team_name = str(team_payload.get("name") or "Team Name").strip()
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Seed team data into your own Supabase project")
    ...
    parser.add_argument("--owner-email", default="team@example.com", help="Owner account email to create/update")
    ...
    parser.add_argument("--school-id", default="school-123", help="Tenant school ID")
...
def main(argv: list[str]) -> int:
    ...
    try:
        ...
        config = SeedConfig(
            ...
            school_id=(args.school_id.strip() or "school-123"),
